...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-[2px] left-[2px] w-[20px] h-[20px] transition-transform duration-300 ease-out ${
          isDark ? "translate-y-[24px]" : "translate-y-0"
        }`}
      >
      ...
      {/* Hand-drawn Sun (Top) */}
      <div
        className={`absolute top-[3px] left-[3px] w-[18px] h-[18px] flex items-center justify-center transition-opacity duration-200 ${
          !isDark ? "opacity-100" : "opacity-30 group-hover:opacity-60"
        }`}
      >
        <svg
          width="13"
      ...
      <div
        className={`absolute bottom-[3px] left-[3px] w-[18px] h-[18px] flex items-center justify-center transition-opacity duration-200 ${
          isDark ? "opacity-100" : "opacity-30 group-hover:opacity-60"
        }`}
      >
        <svg
